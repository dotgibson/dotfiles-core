...
those files (`make gen-aliases`) and `make audit` fails when they drift — as it does for
`PORTING-MATRIX.md`'s two data tables, rendered from the sibling OS repos' `os/*.capabilities`
and `install/packages.txt` by `make gen-porting-matrix`. The updater and
...
[ci-shield]: https://img.shields.io/github/check-runs/dotgibson/dotfiles-core/main?style=plastic&logo=githubactions&logoColor=white&label=CI
[ci-url]: https://github.com/dotgibson/dotfiles-core/actions/workflows/ci.yml
[lastcommit-shield]: https://img.shields.io/github/last-commit/dotgibson/dotfiles-core?branch=main&style=plastic&logo=git&logoColor=white
[contributors-shield]: https://img.shields.io/github/contributors/dotgibson/dotfiles-core.svg?style=plastic&logo=github
[contributors-url]: https://github.com/dotgibson/dotfiles-core/graphs/contributors
[forks-shield]: https://img.shields.io/github/forks/dotgibson/dotfiles-core.svg?style=plastic&logo=github
[forks-url]: https://github.com/dotgibson/dotfiles-core/network/members
[stars-shield]: https://img.shields.io/github/stars/dotgibson/dotfiles-core.svg?style=plastic&logo=github
[stars-url]: https://github.com/dotgibson/dotfiles-core/stargazers
[issues-shield]: https://img.shields.io/github/issues/dotgibson/dotfiles-core?style=plastic&logo=github
[issues-url]: https://github.com/dotgibson/dotfiles-core/issues
[license-shield]: https://img.shields.io/github/license/dotgibson/dotfiles-core.svg?style=plastic
...
[yaml-shield]: https://img.shields.io/badge/YAML-CB171E?style=plastic&logo=yaml&logoColor=white
[yaml-url]: https://github.com/yaml
[json-shield]: https://img.shields.io/badge/JSON-000000?style=plastic&logo=json&logoColor=white
...
[vim-shield]: https://img.shields.io/github/v/tag/vim/vim?sort=semver&style=plastic&logo=vim&logoColor=white&label=Vim&labelColor=019733&color=3D59A1
[vim-url]: https://github.com/vim/vim
[tmux-shield]: https://img.shields.io/github/v/release/tmux/tmux?style=plastic&logo=tmux&logoColor=white&label=tmux&labelColor=1BB91F&color=3D59A1
[tmux-url]: https://github.com/tmux/tmux
[starship-shield]: https://img.shields.io/github/v/release/starship/starship?style=plastic&logo=starship&logoColor=white&label=Starship&labelColor=DD0B78&color=3D59A1
...
[jujutsu-shield]: https://img.shields.io/github/v/release/jj-vcs/jj?style=plastic&logo=gnometerminal&logoColor=24283B&label=jujutsu&labelColor=BB9AF7&color=3D59A1
[jujutsu-url]: https://github.com/jj-vcs/jj
[atuin-shield]: https://img.shields.io/github/v/release/atuinsh/atuin?style=plastic&logo=gnometerminal&logoColor=24283B&label=atuin&labelColor=BB9AF7&color=3D59A1
[atuin-url]: https://github.com/atuinsh/atuin
[sesh-shield]: https://img.shields.io/github/v/release/joshmedeski/sesh?style=plastic&logo=gnometerminal&logoColor=24283B&label=sesh&labelColor=BB9AF7&color=3D59A1
