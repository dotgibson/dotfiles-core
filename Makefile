...
fleet-vendor-guidance: ## Does every repo's core/ vendoring hint pin the CURRENT released tag? (the vendoring-hint register)
	@./scripts/fleet-vendor-guidance.sh
...
update-fleet-versions: ## Re-read the fleet package versions from upstream and regenerate the matrix
	@./scripts/update-fleet-versions.sh
...
gen-porting-matrix: ## Regenerate PORTING-MATRIX.md's generated blocks from the OS repos + the fleet-version TSV (edit the source, not the table)
