...
1. **Ratchet the four 1/9 helpers to the fleet.** `blib_resolve_su`,
   ...
   *ready*, and it is not breaking. *Started 2026-09-13: Debian, Fedora, openSUSE and Alpine
   adopted all four (dotgibson/dotfiles-Debian#75, dotgibson/dotfiles-Fedora#178,
   dotgibson/dotfiles-openSUSE#183, dotgibson/dotfiles-Alpine#191), so the rows read 5/9;
   #973 tracks the other three repos with each one's measured friction.*
