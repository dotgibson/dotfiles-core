...
META_ALLOWLIST=(
  ...
  PARITY.md RELEASE-STRATEGY.md RELEASE-RUNBOOK.md GITHUB-APP-AUTH.md GITHUB-APP-MIGRATION.md V5-PROPOSAL.md V8-PROPOSAL.md
...
#   BLIB_DRY 9/9
#   (the four 1/9 rows became 3/9 on 2026-09-13 when Debian and Fedora adopted; #867)
#
