...
#   blib_wire_summary 8/9 · blib_install_core_guard 8/9 · BLIB_DRY 9/9 · blib_main 4/9
...
#   instead of wrapping it. A blib_main caller is credited with the whole contract, since the
#   driver calls every helper above. #986 ratchets the rest; MacBook stays outside by design.)
...
blib_main                dotfiles-Debian dotfiles-Defense dotfiles-Fedora dotfiles-openSUSE
'
  _ha_checked=0
  _ha_missing=0
  _ha_absent=0
