...
#   blib_wire_summary 8/9 · blib_install_core_guard 9/9 · BLIB_DRY 9/9 · blib_main 4/9
...
#   never installed, so blib_install_core_guard closes at 9/9. A blib_main caller is credited
